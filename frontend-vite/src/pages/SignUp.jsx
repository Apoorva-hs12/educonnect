    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F6FAFD] p-4">
      <div className="w-full max-w-[500px] bg-white rounded-xl shadow-sm border border-[#E0E0E0] p-8 md:p-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#0A1931]">Create Your Account</h1>
          <p className="text-[#757575] mt-1 text-center font-medium">Join thousands learning together on EduConnect</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-[#0A1931] mb-2">Full Name</label>
            <input
              type="text"
              name="fullName"
          ...
          <div className="relative">
            <label className="block text-sm font-semibold text-[#0A1931] mb-2">Password</label>
            <div className="relative">
              <input
          ...
          <div className="relative">
            <label className="block text-sm font-semibold text-[#0A1931] mb-2">Confirm Password</label>
            <div className="relative">
              <input
          ...
          <div>
            <label className="block text-sm font-semibold text-[#0A1931] mb-2">I am a (Role)</label>
            <select
              name="role"
          ...
          <div className="flex items-center gap-2 py-2">
            <input type="checkbox" id="terms" className="w-4 h-4 rounded border-[#E0E0E0] text-[#4A7FA7]" required />
            <label htmlFor="terms" className="text-sm text-[#757575] font-medium">
              I agree to <Link to="#" className="text-[#4A7FA7] hover:underline font-bold">Terms & Conditions</Link>
            </label>
          </div>
          ...
          <div className="text-center pt-4">
            <p className="text-sm text-[#757575] font-medium">
              Already have an account? <Link to="/signin" className="text-[#4A7FA7] font-bold hover:underline">Sign In</Link>
            </p>
          </div>
        </form>
      </div>
